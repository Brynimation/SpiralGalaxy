...
public class BlitMaterialFeature : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public CustomRenderPass(string name, Material material, int materialPassIndex = -1) : base()
        {
            this.name = name;
            this.material = material;
            this.materialPassIndex = materialPassIndex;
            tempTexture.Init("TempBlitMaterialTexture");
        }
    ...
    public class Settings
    {
        ...
        public Settings(Material material = null, RenderPassEvent renderEvent = RenderPassEvent.AfterRenderingPostProcessing, int materialPassIndex = -1)
        {
            this.material = material;
            this.materialPassIndex = materialPassIndex;  //-1 means all renderpasses
    ...
    /// <inheritdoc/>
    /// In our create function, we can pass a material to our RenderPass.
    public override void Create()
    {
        renderPass = new CustomRenderPass(name, settings.material, settings.materialPassIndex);
